...
//   NSURL *url=[NSURL URLWithString:@"http://appshopper.com/feed/?device=iPhone&mode=featured&filter=price"];
//     NSURL *url=[NSURL URLWithString:@"http://twitter.com/status/user_timeline/github"];
//   NSURL *url=[NSURL URLWithString:@"http://news.google.com/?output=rss"];
//NSURL *url=[NSURL URLWithString:@"http://192.168.2.78/ReedyWcfService/Users/ValidateUser?userEmailAddress=iphoneandroid.testing@gmail.com&password=123"];
//NSError *parseError = nil;
//NSError *error = nil;
//NSDictionary *xmlDictionary = [XMLReader dictionaryForXMLString:[NSString stringWithContentsOfURL:url encoding:NSUTF8StringEncoding error:&error] error:&parseError];
//NSLog(@"%@",xmlDictionary);
